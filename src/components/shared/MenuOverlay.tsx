    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-10">
        ...
        <div className="flex items-center gap-6 text-accent/40">
          ...
          >
            <svg viewBox="0 0 98 96" className="w-6 h-6" fill="currentColor" aria-hidden="true">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
          ...
          <a
            ...
            className="hover:text-accent transition-colors"
          >
            <svg viewBox="0 0 1920 1920" className="w-6 h-6" fill="currentColor" aria-hidden="true">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
