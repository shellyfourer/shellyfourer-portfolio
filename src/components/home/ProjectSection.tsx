...
export default function ProjectSection() {
    return (
        <section id="projects" className="flex flex-col justify-center gap-8
            ...
            <div className="rounded-xl border border-border/25 overflow-hidden max-w-3xl bg-surface">
                ...
                {/* Screenshot */}
                <Link href="https://kristinafourer.com" target="_blank" rel="noopener noreferrer" className="block">
                    <Image
                        src="/project1.png"
